"use client";
import { useGetLatestOffers } from "@/data/hooks";
...
export default function LatestOfferContainer() {
  const [page, setPage] = useState(1);
  const { data, isLoading, isError } = useGetLatestOffers(page);
