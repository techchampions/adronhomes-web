...
// interface LocationAutocomplete2Props {
//   value: string;
...
//   );
// };
// const apiKey = "AIzaSyBPIyWllHG8je77s56Pyp69b5mzlghzD9U";

// const LocationAutocomplete2: React.FC<LocationAutocomplete2Props> = ({
//   value,
//   onChange,
//   onSelect,
//   onError,
...
//     if (scriptRef.current || isLoadingScript) {
//       return;
//     }
...
//     };
//   }, [onError, isLoadingScript, scriptLoaded]);

//   // Alternative method: Check periodically if Google Maps loaded
//   useEffect(() => {
...
//     if (!isGoogleLoaded) {
//       const errorMsg = "Google Maps is still loading. Please try again.";
//       setInternalError(errorMsg);
//       if (onError) onError(errorMsg);
//       return;
//     }
