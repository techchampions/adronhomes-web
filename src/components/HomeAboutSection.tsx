    ...
    <section className="py-16 px-10 w-full mx-auto bg-white">
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="w-full lg:w-1/2">
          <div className="relative w-full h-96 md:h-[400px] rounded-3xl overflow-hidden">
            <Image
        ...
        <div className="w-full lg:w-1/2 lg:pl-8">
          ...
          <p className="text-gray-600 mb-8 text-lg leading-relaxed">
            ...
            mission is to exceed expectations.
          </p>

          {/* CTA Button */}
          <a
            href="/about"
            className="inline-block bg-adron-green text-white font-medium py-3 px-8 rounded-full transition-colors"
          >
            About Us
          </a>
        </div>
